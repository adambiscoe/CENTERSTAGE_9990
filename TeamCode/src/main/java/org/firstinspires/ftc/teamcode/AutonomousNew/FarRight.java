    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()){
            ...
            if (choice.equals("LEFT")){
                ...
                robot.armUp();
                sleep(500);
                robot.moveEncoder(7, .5);
            }
            else if (choice.equals("RIGHT")){
                robot.turnRightEncoder(RIGHT_ANGLE_POSITION);
                robot.moveEncoder(-12, .5);
                robot.propDropYellow();
                robot.moveEncoder(11, .5);
                robot.clawOpen();
                sleep(750);
                robot.moveEncoder(-12, .5);
                robot.armDown();
                robot.strafeRightEncoder(STRAFE_FULL_SQUARE, .5);
                robot.moveEncoder(83, .7);
                //robot.strafeRightEncoder(STRAFE_FULL_SQUARE, .7); // currently placing pixel on tape
                robot.armUp();
                //robot.strafeLeftEncoder(STRAFE_FULL_SQUARE, .7);
                robot.moveEncoder(4, .7);
                ...
                robot.moveEncoder(-19, .5);
                robot.turnRightEncoder(RIGHT_ANGLE_POSITION);
                robot.moveEncoder(69, .7);
