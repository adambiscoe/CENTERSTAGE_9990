...
@Autonomous
public class Auton2827 extends LinearOpMode {
    ...
    static final int PROP_ANGLE_POSITION = 530;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()){
            ...
            if (choice.equals("RIGHT")){
                ...
                robot.moveEncoder(20, .5);
                /*
                robot.moveEncoder(-18, .7);
                robot.turnRightEncoder(RIGHT_ANGLE_POSITION);
                robot.claw.setPower(1);
                sleep(2000);
                robot.scoopDown();
                robot.armDown();
                robot.moveEncoder(33, .7);
                robot.strafeLeftEncoder(STRAFE_FULL_SQUARE - 150, .7);
            ...
            robot.strafeRightEncoder(1000/5, .4);
            robot.moveEncoder(4, .5);
             */
            break;
