        ...
        while (opModeIsActive()){
            ...
            if (choice.equals("RIGHT")){
               ...
               // robot.moveEncoder(-2, .5);
                ...
                robot.strafeRightEncoder(400, .5);
                //robot.claw.();
                robot.armUp();
                sleep(500);
                robot.strafeLeftEncoder(STRAFE_FULL_SQUARE + 400, .5);
                robot.moveEncoder(5, .5);
            }
                ...
                robot.turnLeftEncoder(RIGHT_ANGLE_POSITION + 40);
                robot.moveEncoder(32, .7);
                robot.strafeRightEncoder(STRAFE_FULL_SQUARE - 200, .5);
                //robot.moveEncoder(4, .5);
                robot.armUp();
                robot.strafeLeftEncoder(STRAFE_FULL_SQUARE - 300,.5);
               ...
               // robot.claw.setPower(1);
                ...
                robot.moveEncoder(32, .7);
               // robot.strafeRightEncoder(200, .5);
